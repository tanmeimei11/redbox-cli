...
var downImg = function (url, writeS) { return new Promise(function (resolve) { return https_1.get(url, function (imgRes) {
    imgRes.pipe(writeS);
    writeS.on('close', function () { return resolve(); });
...
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        files.forEach(function (file) { return __awaiter(_this, void 0, void 0, function () {
            var _a, path, name, hash, blueName, tinyPath, tinyData, _b, input, output, writeS, compressHash, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, downImg(output.url, writeS)];
                    case 4:
                        _c.sent();
                    ...
                    case 6:
                        error_1 = _c.sent();
                        spinner.fail("\u538B\u7F29\u5931\u8D25 " + utils_1.chalk.red(file));
                        return [3 /*break*/, 7];
