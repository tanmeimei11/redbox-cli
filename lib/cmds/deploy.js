...
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var prompt, curBranch, defBranch, redboxResPath, redboxH5Path, resultReg, answer, numb, _a, _b, data, result, now, isSucc, error_1;
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prompt([{
                            ...
                            type: 'confirm',
                            name: 'ok',
                            message: function (answers) { return "\u6267\u884C" + utils_1.lastSpilt(answers.job, '/') + " \u90E8\u7F72 \u5206\u652F[" + utils_1.lastSpilt(answers.branch, '/') + "] \u5230 " + answers.env; },
                            default: false
                        }])];
            case 2:
                answer = _c.sent();
