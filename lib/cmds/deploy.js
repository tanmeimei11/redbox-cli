...
var jenkisPost = function (data, path) { return new Promise(function (resolve, reject) {
    ...
    var req = http_1.request(reqConfig({ body: body, path: path }), function (res) {
        var rawData = '';
...
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var prompt, curBranch, defBranch, redboxRes, redboxResPath, resultReg, spinner, answer, numb, _a, _b, data, result, now, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                redboxRes = ['QA', 'QA2', 'QA3', 'QA_unit', 'webtest'];
                redboxResPath = "redbox-res/job/redbox_res_onekey_deploy";
                resultReg = /^{"result":"(\w+)"}$/;
                spinner = ora('开始部署').start().info();
                return [4 /*yield*/, prompt([{
                            ...
                            choices: [
                                argv.branch
                            ].concat(defBranch.filter(function (b) { return b !== curBranch; })),
                            filter: function (val) { return "origin/" + val; }
                        }, {
                            type: 'list',
                            name: 'env',
                            message: '选择要部署的环境',
            ...
            case 2:
                _c.trys.push([2, 9, , 10]);
                _b = (_a = /(\d+)/).exec;
                return [4 /*yield*/, jenkisPost({}, redboxResPath + "/api/json?tree=nextBuildNumber")];
            case 3:
            ...
            case 5:
                ...
                return [4 /*yield*/, jenkisPost({}, redboxResPath + "/" + numb + "/api/json?tree=result")];
            case 6:
                result = _c.sent();
