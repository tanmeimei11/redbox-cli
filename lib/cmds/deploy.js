...
var spinner = ora('开始检查配置').start();
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var prompt, curBranch, defBranch, redboxResPath, redboxH5Path, resultReg, answer, confirm, numb, _a, _b, data, result, now, isSucc, error_1;
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prompt([{
                            ...
                            when: function (answers) { return answers.job === redboxResPath; }
                        }, {
                            type: 'list',
                            name: 'env',
                            message: '选择要部署的环境',
                            ...
                            when: function (answers) { return answers.job === redboxH5Path; }
                        }, {
                            type: 'list',
                            name: 'env',
                            message: '选择要部署的环境',
            ...
            case 2:
                ...
                return [4 /*yield*/, prompt({
                        type: 'confirm',
                        name: 'ok',
                        message: "\u6267\u884C" + utils_1.lastSpilt(answer.job, '/') + " \u90E8\u7F72 \u5206\u652F[" + utils_1.lastSpilt(answer.branch, '/') + "] \u5230 " + answer.env,
                        default: false
                    })];
            case 3:
                confirm = _c.sent();
            ...
            case 5:
                ...
                _c.label = 6;
            case 6:
                if (!!resultReg.test(result)) return [3 /*break*/, 9];
