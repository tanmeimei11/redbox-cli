        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prompt([{
                            ...
                            type: 'confirm',
                            name: 'ok',
                            message: function (answers) { return "\u6267\u884C" + utils_1.lastSpilt(answers.job, '/') + "\u5206\u652F[" + answers.branch.replace(/^origin\//, '') + "]\u90E8\u7F72\u5230[" + answers.env + "]"; },
                            default: false
                        }])];
            case 2:
                answer = _c.sent();
            ...
            case 8:
                ...
                node_notifier_1.notify({
                    ...
                    'message': "\u5206\u652F[" + answer.branch.replace(/^origin\//, '') + "]\u90E8\u7F72\u5230[" + answer.env + "]" + (isSucc ? '成功' : '失败')
                });
                return [3 /*break*/, 10];
            case 9:
                error_1 = _c.sent();
