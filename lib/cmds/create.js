...
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    var spinner, prompt, projectPath, answer, template, dest, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                projectPath = path_1.join(currPath, projectName);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 5, , 6]);
            ...
            case 2:
                ...
                dest = path_1.join(projectPath, answer.template);
                return [4 /*yield*/, downloadRepo(template, dest)];
            case 3:
                _a.sent();
                return [4 /*yield*/, installDepence()];
            case 4:
                _a.sent();
                return [3 /*break*/, 6];
            case 5:
...
function downloadRepo(template, dest) {
    return new Promise(function (resolve, reject) {
        ...
        download(template, dest, { clone: true }, function (err) {
            ...
            shelljs_1.cp('-R', dest + "/template/*", path_1.join(currPath, projectName));
            shelljs_1.rm('-rf', dest);
            resolve();
        });
    });
}
function installDepence() {
