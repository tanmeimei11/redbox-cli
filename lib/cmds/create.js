...
var tplBranch = ["promo-tpl", "super-tpl"];
exports.handler = function (argv) { return __awaiter(_this, void 0, void 0, function () {
    function installDepence(projectName, spinner) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        spinner.succeed();
                        isYarn = shelljs_1.which('yarn');
                        command = isYarn ? 'yarn' : 'npm';
                        shelljs_1.cd(projectName || '.');
                        return [4 /*yield*/, execPromise(command + " install")];
                    case 1:
                        _a.sent();
    ...
    function downloadRepo(template, dest, projectName) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            download(template, dest, { clone: true }, function (err) {
                ...
                resolve(execPromise("cp -r " + dest + "/template/ " + path_1.join(process.cwd(), projectName)).then(function (res) {
                    shelljs_1.rm('-rf', dest);
    ...
    var spinner, prompt, execPromise, answer, projectName, template, dest, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                spinner = ora('开始创建').info();
                prompt = inquirer_1.createPromptModule();
                execPromise = function (cmd) { return new Promise(function (resolve, reject) {
                    var child = shelljs_1.exec(cmd, function (code, out) {
                        resolve(out);
                    });
            ...
            case 1:
                ...
                return [4 /*yield*/, prompt([{
                            ...
                            type: 'confirm',
                            name: 'newDir',
                            message: function (answers) { return "\u521B\u5EFA\u65B0\u7684\u76EE\u5F55" + argv.projectName + "\u5417?"; },
                            default: true
                        }])];
            case 2:
                answer = _a.sent();
                projectName = answer.newDir ? argv.projectName : '';
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, installDepence(projectName, spinner)];
            case 4:
                _a.sent();
