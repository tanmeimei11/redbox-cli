 ...
 * @param param0
 */
exports.findFiles = function (_a) {
    var globdir = _a.globdir;
    var spinner = ora('开始查找文件').start();
    var files = shelljs_1.ls(globdir);
...
exports.chalk = {
    red: function (str) { return "\u001B[1;31m" + str + "\u001B[0m"; },
    blue: function (str) { return "\u001B[1;34m" + str + "\u001B[0m"; }
};
